...
B=ciao_W06_WI09_NOoverlap;
A(9,1)=0.9;
A(9,2)=(max(B(:,2))-min(B(:,2)))/max(B(:,2));
A(9,3)=(max(B(:,3))-min(B(:,3)))/max(B(:,3)); ;
dlmwrite("stat_diff_W06.dat",A, "\t", "precision", 4);
