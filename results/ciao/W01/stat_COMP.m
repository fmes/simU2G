...
A(:,3)=ciao_W01_WI02_NOoverlap(:,2);
load ciao_W01_WI03_NOoverlap;
A(:,4)=ciao_W01_WI03_NOoverlap(:,2);
load ciao_W01_WI04_NOoverlap;
A(:,5)=ciao_W01_WI04_NOoverlap(:,2);
load ciao_W01_WI05_NOoverlap;
A(:,6)=ciao_W01_WI05_NOoverlap(:,2);
load ciao_W01_WI06_NOoverlap;
A(:,7)=ciao_W01_WI06_NOoverlap(:,2);
load ciao_W01_WI07_NOoverlap;
A(:,8)=ciao_W01_WI07_NOoverlap(:,2);
load ciao_W01_WI08_NOoverlap;
A(:,9)=ciao_W01_WI08_NOoverlap(:,2);
load ciao_W01_WI09_NOoverlap;
A(:,10)=ciao_W01_WI09_NOoverlap(:,2);
